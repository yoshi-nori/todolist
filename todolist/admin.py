...
class TodoModelAdmin(admin.ModelAdmin):
    """
    filterに期限がいつまでとかでフィルターできるようにする
    """
    list_display = ('id', 'title', 'limit_time', 'achievement_rate')
    list_filter = ('achievement_rate', 'work_date_model', )
    search_fields = ('title', 'work_date_model', )
